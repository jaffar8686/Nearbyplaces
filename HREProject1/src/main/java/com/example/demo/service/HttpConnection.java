...
public class HttpConnection {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(HttpConnection.class.getName());
	 ...
	 public HttpConnection() {}
	    ...
	    public HttpConnection(HotelRepository hotelRepository,String lat,String lon,String cat) {
	        this.hotelRepository = hotelRepository;
	    }
	    public HttpConnection(RestaurantRepository restaurantRepository,String lat,String lon,String cat) {
	        this.restaurantRepository = restaurantRepository;
	    }
	    public HttpConnection(EntertainmentRepository entertainmentRepository,String lat,String lon,String cat) {
    ...
    hotel.setPost_code(post_code);
    hotel.setTimezone(timezone);
    hotel.setRegion(region);
    hotel.setCountry(country);
    hotel.setCross_street(cross_street);
	...
	try{
	URL url = new URL("https://api.foursquare.com/v3/places/nearby?ll="+lat+"%2C"+lon+"+&query="+cat+"");
