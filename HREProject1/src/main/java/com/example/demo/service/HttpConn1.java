...
public class HttpConn1 {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(HttpConn1.class.getName());
	...
	public HttpConn1(HotelRepository hotelRepository,String latitude,String longitude) {
	...
	public  ArrayList parse(String responseBody) {
		...
		List<Hotel> nearPlaces=new ArrayList<>(); 
	 ...
	 public  ArrayList getPlaces() {
		...
		try{
		URL url = new URL("https://api.foursquare.com/v3/places/nearby?ll="+lat+"%2C"+lon+"&query=hotel");
